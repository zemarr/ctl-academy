...
export function GallerySection() {
  ...
  return (
    <section ref={containerRef} id="gallery" className="relative px-6 md:px-10 py-24 md:py-32 overflow-hidden">
      <div className="max-w-400 mx-auto">
        <FadeIn>
          <div className="flex flex-col lg:flex-row items-end lg:justify-between gap-8 md:mb-14 mb-8">
            <div>
              ...
              {cats.map((c) => (
                <button
                  ...
                  className={
                    ...
                    (active === c ? "text-black bg-foreground/40" : "text-foreground/70 hover:bg-foreground/20 hover:text-foreground")
                  }
                >
                  {active === c && (
                    <motion.span
